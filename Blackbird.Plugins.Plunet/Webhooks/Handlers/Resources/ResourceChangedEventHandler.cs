...
public class ResourceChangedEventHandler : IWebhookEventHandler
{
    ...
    {
        await ResourceClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.StatusChanged);
    }
    ...
    {
        await ResourceClient.DeregisterCallback(authenticationCredentialsProviders, EventType.StatusChanged);
    }
}