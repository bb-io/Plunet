...
public class ResourceDeleteEventHandler : IWebhookEventHandler
{
    ...
    {
        await ResourceClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.ENTRY_DELETED);
    }
    ...
    {
        await ResourceClient.DeregisterCallback(authenticationCredentialsProviders, EventType.ENTRY_DELETED);
    }
}