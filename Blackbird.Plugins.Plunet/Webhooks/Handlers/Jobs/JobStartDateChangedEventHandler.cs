...
public class JobStartDateChangedEventHandler : IWebhookEventHandler
{
    ...
    {
        await JobClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.START_DATE_CHANGED);
    }
    ...
    {
        await JobClient.DeregisterCallback(authenticationCredentialsProviders, EventType.START_DATE_CHANGED);
    }
}