...
public class JobCreatedEventHandler : IWebhookEventHandler
{
    ...
    {
        await JobClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.NEW_ENTRY_CREATED);
    }
    ...
    {
        await JobClient.DeregisterCallback(authenticationCredentialsProviders, EventType.NEW_ENTRY_CREATED);
    }
}