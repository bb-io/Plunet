...
public class JobChangedEventHandler : IWebhookEventHandler
{
    ...
    {
        await JobClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.STATUS_CHANGED);
    }
    ...
    {
        await JobClient.DeregisterCallback(authenticationCredentialsProviders, EventType.STATUS_CHANGED);
    }
}