...
public class ItemChangedEventHandler : IWebhookEventHandler
{
    ...
    {
        await ItemClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.STATUS_CHANGED);
    }
    ...
    {
        await ItemClient.DeregisterCallback(authenticationCredentialsProviders, EventType.STATUS_CHANGED);
    }
}