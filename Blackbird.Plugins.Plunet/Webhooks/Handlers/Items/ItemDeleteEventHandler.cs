...
public class ItemDeleteEventHandler : IWebhookEventHandler
{
    ...
    {
        await ItemClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.ENTRY_DELETED);
    }
    ...
    {
        await ItemClient.DeregisterCallback(authenticationCredentialsProviders, EventType.ENTRY_DELETED);
    }
}