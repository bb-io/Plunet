...
public class ItemCreatedEventHandler : IWebhookEventHandler
{
    ...
    {
        await ItemClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.NEW_ENTRY_CREATED);
    }
    ...
    {
        await ItemClient.DeregisterCallback(authenticationCredentialsProviders, EventType.NEW_ENTRY_CREATED);
    }
}