...
public class RequestChangedEventHandler : IWebhookEventHandler
{
    ...
    {
        await RequestClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.STATUS_CHANGED);
    }
    ...
    {
        await RequestClient.DeregisterCallback(authenticationCredentialsProviders, EventType.STATUS_CHANGED);
    }
}