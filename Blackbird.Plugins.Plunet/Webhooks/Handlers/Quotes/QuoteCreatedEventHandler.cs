...
public class QuoteCreatedEventHandler : IWebhookEventHandler
{
    ...
    {
        await QuoteClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.NEW_ENTRY_CREATED);
    }
    ...
    {
        await QuoteClient.DeregisterCallback(authenticationCredentialsProviders, EventType.NEW_ENTRY_CREATED);
    }
}