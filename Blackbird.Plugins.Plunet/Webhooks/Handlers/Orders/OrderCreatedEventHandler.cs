...
public class OrderCreatedEventHandler : IWebhookEventHandler
{
    ...
    {
        await OrderClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.NEW_ENTRY_CREATED);
    }
    ...
    {
        await OrderClient.DeregisterCallback(authenticationCredentialsProviders, EventType.NEW_ENTRY_CREATED);
    }
}