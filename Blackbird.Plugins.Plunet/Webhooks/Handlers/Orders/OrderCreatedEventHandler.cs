...
public class OrderCreatedEventHandler : IWebhookEventHandler
{
    ...
    {
        await OrderClient.RegisterCallback(authenticationCredentialsProviders, values, EventType.NewEntryCreated);
    }
    ...
    {
        await OrderClient.DeregisterCallback(authenticationCredentialsProviders, EventType.NewEntryCreated);
    }
}